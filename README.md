...
_`permissions` must be an array containing one or more of the following: `read`, `deposit`, `transfer`._
...
```json
{
  ...
  "api_key": "sk_test_DUMMY_KEY_WILL_BE_VALID_FOR_A_SHORT_TIME",
  "environment": "test",
...
- 400 BadRequest: Invalid expiry format or invalid permissions requested.
...
```json
{
  ...
  "api_key": "sk_live_DUMMY_ROLLED_OVER_KEY",
...
```json
{
  ...
  "status": "success",
  "amount": 5000,
  "paid_at": "2024-01-30T10:05:00.000Z",
  "channel": "card",
